...
class Equipment_sortView(QtWidgets.QDialog):
    def __init__(self):
        ...
        self.ui.checkB_statusOn.setText('В эксплуатации')
        self.ui.checkB_statusOff.setText('Не в эксплуатации')
        ...
        current_indexPage = config['Equipment']['current_indexPage']
    ...
    def load_status(self):
        self.ui.checkB_statusOn.setChecked(Helper_all.convert_bool(config['Equipment']['checkB_statusOn']))
        self.ui.checkB_statusOff.setChecked(Helper_all.convert_bool(config['Equipment']['checkB_statusOff']))
    ...
    def clicked_btn_save(self):
        config['Equipment']['checkBox_all_Branch'] = self.tab_branch.checkBox_all.isChecked()
        config['Equipment']['checked_item_Branch'] = self.get_Checked_id_tW(self.tab_branch.tW_item)

        config['Equipment']['checkBox_all_Department'] = self.tab_department.checkBox_all.isChecked()
        config['Equipment']['checked_item_Department'] = self.get_Checked_id_tW(self.tab_department.tW_item)

        config['Equipment']['checkBox_all_ServiceDepartment'] = self.tab_serviceDepartment.checkBox_all.isChecked()
        config['Equipment']['checked_item_ServiceDepartment'] = self.get_Checked_id_tW(self.tab_serviceDepartment.tW_item)
    ...
    def insertTab_department(self, index_page):
        ...
        helper_module = {'Equipment': 'Department'}
    ...
    def insertTab_branch(self, index_page):
        ...
        helper_module = {'Equipment': 'Branch'}
    ...
    def insertTab_serviceDepartment(self, index_page):
        ...
        helper_module = {'Equipment': 'ServiceDepartment'}
